...
export const SET_TRACELISTBYTIME = "SET_TRACELISTBYTIME";
export const SET_TRACELISTBYTIME_TOTAL = "SET_TRACELISTBYTIME_TOTAL";
...
export const SET_TRACEBYTIME_FORM = "SET_TRACEBYTIME_FORM";
